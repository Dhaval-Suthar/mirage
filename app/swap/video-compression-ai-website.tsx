...
import { FileVideo, Upload, ArrowRight, CheckCircle } from 'lucide-react';
...
const VideoCompressionAI = () => {
  ...
  const handleFileUpload = (e) => {
    ...
    if (file) {
      ...
      setUploadProgress(0);
      setTimeout(() => {
        setCompressedSize(Math.floor(file.size * 0.6));
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl w-full space-y-16">
          ...
          <footer className="text-center text-gray-500 text-sm">
            © 2024 NanoVid AI. Revolutionizing video compression with artificial intelligence.
          </footer>
        </div>
      </div>
    </div>
